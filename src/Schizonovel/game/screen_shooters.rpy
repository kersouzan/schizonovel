    ...
    frame:
        ...
        vbox:
            imagebutton:
                ...
                action [Hide(), Jump("shooter_food")]

            imagebutton:
                #xpos 50
                #ypos 320
                idle "alcool_button.png"
                action [Hide(), Jump("shooter_alcool")]

            imagebutton:
                #xpos 50
                #ypos 440
                idle "cigarette_button.png"
                action [Hide(), Jump("shooter_cigarette")]

            imagebutton:
                #xpos 50
                #ypos 560
                idle "joints_button.png"
                action [Hide(), Jump("shooter_joints")]

            imagebutton:
                #xpos 50
                #ypos 680
                idle "benzo_button.png"
                action [Hide(), Jump("shooter_benzo")]
